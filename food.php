            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="food.php">Food</a>
                        </li>
                    ...
                    <div class="col text-center">
                        <div class="card h-100 p-r">
                            <div class="img-animal m-1">
                                <?php echo $singleFood->getCategory() ?>
                            </div>
                            <img src="<?php echo $singleFood->getImg() ?>" class="card-img-top ">
                            <div class="card-body ">
                                <h5 class="card-title mt-3">
                                    <?php echo $singleFood->getName() ?></h5>
                                <p class="card-text my-2">
                                    <b>Prezzo: </b>
                                    <?php echo $singleFood->getPrice() ?> €
                                </p>
                                <p class="card-text my-2">
                                    <b>Brand: </b>
                                    <?php echo $singleFood->getBrand() ?>
                                </p>
                            </div>
                        </div>
                    </div>
